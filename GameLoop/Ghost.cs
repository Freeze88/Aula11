...
namespace GameLoop
{
    internal class Ghost : MapPiece
    {
        private readonly List<MapPiece> open = new List<MapPiece>();
        private readonly List<MapPiece> closed = new List<MapPiece>();
        private readonly List<MapPiece> neibors = new List<MapPiece>();
        private readonly List<MapPiece> allPieces = new List<MapPiece>();
